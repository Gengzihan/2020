...
! function (e, t) {
    ...
    function T(e, t, n, r) {
        ...
        if (d && (i = p(t, e[0].ownerDocument, !1, e, r), o = i.firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
            ...
            if (a)
                for (l = s[s.length - 1].ownerDocument, ot.map(s, x), f = 0; a > f; f++) u = s[f], Ft.test(u.type || "") && !Et.access(u, "globalEval") && ot.contains(l, u) && (u.src ? ot._evalUrl && ot._evalUrl(u.src) : ot.globalEval(u.textContent.replace(zt, "")))
        }
        return e
    }
    ...
    function I(e, t, n) {
        ...
        for (M(c, l.opts.specialEasing); s > o; o++)
            if (r = I.prefilters[o].call(l, e, c, l.opts)) return ot.isFunction(r.stop) && (ot._queueHooks(l.elem, l.opts.queue).stop = ot.proxy(r.stop, r)), r;
    ...
    ot.fn = ot.prototype = {
        ...
        var e, t, n, r, i, o, s = arguments[0] || {},
            ...
            u = arguments.length,
            l = !1;
        for ("boolean" == typeof s && (l = s, s = arguments[a] || {}, a++), "object" == typeof s || ot.isFunction(s) || (s = {}), a === u && (s = this, a--); u > a; a++)
            if (null != (e = arguments[a]))
                for (t in e) n = s[t], r = e[t], s !== r && (l && r && (ot.isPlainObject(r) || (i = ot.isArray(r))) ? (i ? (i = !1, o = n && ot.isArray(n) ? n : []) : o = n && ot.isPlainObject(n) ? n : {}, s[t] = ot.extend(l, o, r)) : void 0 !== r && (s[t] = r));
        return s
    }, ot.extend({
        ...
        proxy: function _n(e, t) {
            var n, r, _n;
            return "string" == typeof t && (n = e[t], t = e, e = n), ot.isFunction(e) ? (r = Q.call(arguments, 2), _n = function () {
    ...
    var mt, vt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
        yt = ot.fn.init = function (e, t, n) {
            ...
            if (n = n || mt, "string" == typeof e) {
                ...
                if (r[1]) {
                    if (t = t instanceof ot ? t[0] : t, ot.merge(this, ot.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : G, !0)), ht.test(r[1]) && ot.isPlainObject(t))
    ...
    ot.Callbacks = function (e) {
        ...
        when: function (e) {
            ...
            if (s > 1)
                for (t = new Array(s), n = new Array(s), r = new Array(s); s > i; i++) o[i] && ot.isFunction(o[i].promise) ? o[i].promise().progress(l(i, n, t)).done(l(i, r, o)).fail(u.reject) : --a;
    ...
    ot.extend({
        ...
        data: function Un(e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (Un = Nt.get(i), 1 === i.nodeType && !Et.get(i, "hasDataAttrs"))) {
                    for (n = o.length; n--;) o[n] && (r = o[n].name, 0 === r.indexOf("data-") && (r = ot.camelCase(r.slice(5)), u(i, r, Un[r])));
        ...
        queue: function Vn(e, t, n) {
            var Vn;
            return e ? (t = (t || "fx") + "queue", Vn = Et.get(e, t), n && (!Vn || ot.isArray(n) ? Vn = Et.access(e, t, ot.makeArray(n)) : Vn.push(n)), Vn || []) : void 0
        },
    ...
    ot.event = {
        ...
        add: function (e, t, n, r, i) {
            ...
            if (m)
                for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = ot.guid++), (u = m.events) || (u = m.events = {}), (s = m.handle) || (s = m.handle = function (t) {
            ...
            if (a[0] = e, e.delegateTarget = this, !l.preDispatch || l.preDispatch.call(this, e) !== !1) {
                for (s = ot.event.handlers.call(this, e, u), t = 0;
                    ...
                    for (e.currentTarget = i.elem, n = 0;
                        (o = i.handlers[n++]) && !e.isImmediatePropagationStopped();)(!e.rnamespace || e.rnamespace.test(o.namespace)) && (e.handleObj = o, e.data = o.data, r = ((ot.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, a), void 0 !== r && (e.result = r) === !1 && (e.preventDefault(), e.stopPropagation()));
        ...
        style: function Gn(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, s, a = ot.camelCase(t),
                    Gn = e.style;
                return t = ot.cssProps[a] || (ot.cssProps[a] = j(a) || a), s = ot.cssHooks[t] || ot.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i : Gn[t] : (o = typeof n, "string" === o && (i = At.exec(n)) && i[1] && (n = l(e, t, i), o = "number"), null != n && n === n && ("number" === o && (n += i && i[3] || (ot.cssNumber[a] ? "" : "px")), rt.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (Gn[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (Gn[t] = n)), void 0)
            }
        },
        css: function (e, t, n, r) {
            var i, o, s, a = ot.camelCase(t);
            return t = ot.cssProps[a] || (ot.cssProps[a] = j(a) || a), s = ot.cssHooks[t] || ot.cssHooks[a], s && "get" in s && (i = s.get(e, !0, n)), void 0 === i && (i = N(e, t, r)), "normal" === i && t in tn && (i = tn[t]), "" === n || n ? (o = parseFloat(i), n === !0 || isFinite(o) ? o || 0 : i) : i
        }
    ...
    ot.fn.extend({
        ...
        toggleClass: function (e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(ot.isFunction(e) ? function (n) {
                ...
                var t, r, i, o;
                if ("string" === n)
                    for (r = 0, i = ot(this), o = e.match(wt) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
    ...
    ot.extend(ot.event, {
        trigger: function (t, n, r, i) {
            ...
            if (s = a = r = r || G, 3 !== r.nodeType && 8 !== r.nodeType && !mn.test(d + ot.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."), d = h.shift(), h.sort()), l = d.indexOf(":") < 0 && "on" + d, t = t[ot.expando] ? t : new ot.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : ot.makeArray(n, [t]), f = ot.event.special[d] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                ...
                for (o = 0;
                    (s = p[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u : f.bindType || d, c = (Et.get(s, "events") || {})[t.type] && Et.get(s, "handle"), c && c.apply(s, n), c = l && s[l], c && c.apply && kt(s) && (t.result = c.apply(s, n), t.result === !1 && t.preventDefault());
    ...
    ot.fn.load = function (e, t, n) {
        ...
        var r, i, o, s = this,
            a = e.indexOf(" ");
        return a > -1 && (r = ot.trim(e.slice(a)), e = e.slice(0, a)), ot.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), s.length > 0 && ot.ajax({
            url: e,
            type: i || "GET",
            dataType: "html",
            data: t
